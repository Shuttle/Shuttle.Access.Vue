...
const getRoleStatus = () => {
    ...
    api
        .get(`identities/${id.value}/roles?startDateRegistered=${startDateRegistered}`)
        .then(function (response) {
            Array.prototype.forEach.call(response.data, (roleId) => {
                const item = getRoleItem(roleId);
